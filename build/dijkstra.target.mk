...
TARGET := dijkstra
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=dijkstra' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	$(obj).target/$(TARGET)/addons/greeting.o \
	$(obj).target/$(TARGET)/addons/index.o
...
$(builddir)/dijkstra.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/dijkstra.node: LIBS := $(LIBS)
$(builddir)/dijkstra.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/dijkstra.node: TOOLSET := $(TOOLSET)
$(builddir)/dijkstra.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/dijkstra.node
# Add target alias
.PHONY: dijkstra
dijkstra: $(builddir)/dijkstra.node

# Short alias for building this executable.
.PHONY: dijkstra.node
dijkstra.node: $(builddir)/dijkstra.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/dijkstra.node
