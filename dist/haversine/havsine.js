...
exports.HaversineFactory = void 0;
class Haversine {
    /**
     ...
     * @returns {number}
     */
    distance(coordStart, coordEnd, isKilometer = false) {
...
class HaversineFactory {
     ...
     * @returns {number}
     */
    static calc(coordStart, coordEnd, isKilometer = false) {
        return new Haversine().distance(coordStart, coordEnd, isKilometer);
    }
}
exports.HaversineFactory = HaversineFactory;
